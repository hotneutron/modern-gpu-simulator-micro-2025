...
static const std::unordered_map<std::string, OpcodeChar> Hopper_OpcodeMap = {
    ...
    // SIMD Integer (DPX-style) - Hopper new
    {"VHMNMX", OpcodeChar(OP_VHMNMX, HALF_OP)},
    ...
    {"LDCU", OpcodeChar(OP_LDCU, LOAD_OP)},
    ...
    // Hopper-specific Uniform Datapath extensions
    ...
    // Warpgroup Matrix Operations (Tensor Core) - Hopper new
    {"WGMMA", OpcodeChar(OP_HGMMA, TENSOR_CORE_OP)},
    ...
    {"CGAERRBAR", OpcodeChar(OP_CGAERRBAR, MISCELLANEOUS_QUEUE_OP)},
    ...
    {"PREEXIT", OpcodeChar(OP_PREEXIT, BRANCH_OP)},
